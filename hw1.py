...
p2_u = [-1,  1, 1]
p2_v = [ 2, -1, 5]
p2_v_plus_u = [x+y for (x,y) in zip(p2_u,p2_v)]
p2_v_minus_u = [y-x for (x,y) in zip(p2_u,p2_v)]
p2_two_v_minus_u = [2*y-x for (x,y) in zip(p2_u,p2_v)]
p2_v_plus_two_u = [y+(2*x) for (x,y) in zip(p2_u,p2_v)]
